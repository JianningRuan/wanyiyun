...
var be = {
        ...
        init: function() {
                ...
                $('#header>div>div').eq(1).append('<div><em><select><option value="0">微信公众号</option><option value="2">今日头条号</option><option value="3">百家号</option></select><input placeholder="输入您需求的关键词，如“订阅号”"><b>搜索</b></em><ul></ul></div><s><img src="./../theme/images/' + yqtp + '"></s>');
